...
path = input(
    "\nEnter the path of the folder containing the images that need to be sorted: \nex : C:/Users/33608/OneDrive - Fondation EPF/Desktop/ERI/Image processing/Boils/Images/Cluster 3/ \n ")
pathTreated = input(
...
# definition of the coefficient for the brightness modification (no contrast changes only a reduction of the brightness)
alpha = 1
beta = -30

pathTreated_calm = pathTreated + 'Calm Images'
os.mkdir(pathTreated_calm)
...
for i in dir_list:
    ...
    clahe = cv2.createCLAHE(clipLimit=7.5, tileGridSize=(8, 8))
