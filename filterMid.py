...
path = input(
    "\nEnter the path of the folder containing the images that need to be sorted: \nex : C:/Users/33608/OneDrive - Fondation EPF/Desktop/ERI/Image processing/Boils/Images/Cluster 1/ \n ")
pathTreated = input(
...
pathTreated_Mid = pathTreated + 'Mid Images'
os.mkdir(pathTreated_Mid)
